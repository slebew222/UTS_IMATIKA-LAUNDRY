...
<html>
<head>
	<title>IMATIKUY Laundry | Dashboard</title>
	<link rel="stylesheet" href="<?=url('_assets/css/style.css')?>">
	<link rel="shortcut icon" href="<?=url('_assets/img/logo/LOGOIMATIKUY.svg')?>" type="image/x-icon">
</head>
<body>
	...
	<header>
		<nav>
			<div class="logo">
				<a href="<?=url()?>">
					<img src="<?=url('_assets/img/logo/IMATIKUY.svg')?>" alt="IMATIKUY Laundry Logo">
				</a>
			</div>
			<ul class="nav-menu">
				<li>
