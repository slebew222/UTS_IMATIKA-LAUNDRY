...
<head>
   ...
   <link rel="shortcut icon" href="<?=url('_assets/img/logo/IMATIKUY.svg')?>" type="image/x-icon">
      ...
      <div class="invoice">
         <div class="invoice-content">
            <div class="invoice-header">
               <div class="logo">
                  <img src="<?=url('_assets/img/logo/IMATIKUY.png')?>" width="145" alt="Logo rumah laundry">
               </div>
            ...
            <div class="invoice-body">
               ...
               <div class="invoice-footer">
                  <h3 class="foot_logo"><span>IMATIKUY</span> Laundry</h3>
